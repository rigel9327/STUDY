...
var p = [0, 0, 0, 0, 0, 0];
const myLottoPicks = p.length-1;

for (var i = 0; i <= myLottoPicks; i = i + 1) {
...
var r = [0, 0, 0, 0, 0, 0, 0];
const realLottoPicks = r.length-1;
for (var i = 0; i <= realLottoPicks; i = i + 1) {
...
var win = 0;
for (var i = 0; i <= myLottoPicks; i = i + 1) {
    for (var j = 0; j <= realLottoPicks; j = j + 1) {
        if (p[i] == r[j]) {
            win = win + 1;
        }
    }
